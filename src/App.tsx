          ...
          <div className="bg-[#4B4D54] rounded-[32px] p-8 md:p-12 shadow-xl relative overflow-hidden text-left flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="relative z-10">
              <h3 className="text-2xl md:text-3xl font-heading font-light text-white mb-2">
                En Urozen tenemos{" "}
                <span className="font-black text-[#ffaa00]">la solución.</span>
              </h3>
              <p className="text-slate-300">
                Detén las molestias hoy mismo con nuestro equipo de
                super-especialistas.
              </p>
            </div>
            <button
              onClick={scrollToContact}
              className="relative z-10 px-8 py-4 bg-[#ffaa00] text-white font-black rounded-full shadow-lg hover:scale-105 transition-transform whitespace-nowrap text-sm uppercase tracking-widest"
            >
          ...
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div>
              ...
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-heading font-light text-[#4B4D54] tracking-tight">
                Servicios{" "}
                <span className="font-black text-[#ffaa00]">Destacados.</span>
              </h2>
            </div>
            ...
            {[
              {
                ...
                desc: "Diagnóstico y tratamiento de enfermedades del tracto urinario masculino y femenino con la más alta precisión.",
              },
              {
                icon: <FaAward />,
                title: "Urología Oncológica",
                desc: "Abordaje multidisciplinario para el cáncer de próstata, riñón y vejiga utilizando tecnología robótica.",
              },
              {
                icon: <FaCheckCircle />,
                title: "Estética Íntima Masculina",
                desc: "Procedimientos avanzados y seguros para mejorar la estética y funcionalidad con total discreción.",
              },
              {
                icon: <FaUser />,
                title: "Urología Femenina",
                desc: "Soluciones definitivas para incontinencia urinaria y prolapso pélvico por especialistas dedicados.",
              },
              {
                icon: <FaHeartbeat />,
                title: "Andrología y Disfunciones",
                desc: "Tratamientos vanguardistas para recuperar tu vida sexual y problemas de infertilidad masculina.",
              },
              {
                icon: <FaMicroscope />,
                title: "Cirugía Láser Mínimamente Invasiva",
                desc: "Procedimientos sin cortes grandes, recuperación rápida y menor dolor para cálculos renales y próstata.",
              },
            ].map((service, i) => (
              <div
                key={i}
                className="bg-slate-50 rounded-3xl p-8 border border-slate-100 hover:shadow-2xl hover:border-[#ffaa00]/30 transition-all group flex flex-col"
              >
                ...
                <p className="text-[#4B4D54] mb-8 flex-grow leading-relaxed">
                  {service.desc}
                </p>
                <button className="text-[#ffaa00] font-bold text-sm uppercase tracking-widest inline-flex items-center gap-2 group-hover:gap-4 transition-all w-fit">
                  Más info <FaArrowRight className="w-4 h-4" />
                </button>
              </div>
            ))}
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <h2 className="text-5xl md:text-6xl lg:text-7xl font-heading font-light text-white mb-12 tracking-tight">
                ...
                <span className="font-black text-[#ffaa00]">tu confianza.</span>
              </h2>
